...
This package aims to support both competitors developing rescue agents and researchers studying multi-agent systems, by providing tools to read, visualize, and analyze RRS data — including map data, scenario configurations.
